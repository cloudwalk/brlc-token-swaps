...
interface ISwapPoolTypes {
    ...
    enum SwapStatus {
        ...
        Executed, // 1 The status of a successfully finalized swap.
 ...
 * @author CloudWalk Inc.
 * @dev The interface of the SwapPool types.
 */
interface ISwapPool is ISwapPoolTypes {
     ...
     */
    event TokensWithdrawal(address receiver, address token, uint256 amount);
